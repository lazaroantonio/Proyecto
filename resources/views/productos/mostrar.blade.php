...
<div class="container bootstrap snipets">
    ...
    <div class="float-right">
        <button class="btn btn-outline-secondary" >
            <a class="nav-link" href="{{ url ("productos/create")}}"><font color="white">Agregar</font></a>
        </button>
      </div>
    <div class="row flow-offset-1">
      ...
      <div class="col-xs-6 col-md-4">
        <div class="product tumbnail thumbnail-3"><a href="#"><img class="rounded" src="{{ asset('storage').'/'.$item->imagen}}" style="width:200px; height:200px;" alt=""></a>
          <div class="caption">
            <h6><a href="#">{{$item->Producto}}</a></h6><span class="price">
              <font color="white" ></span><span class="price sale">{{$item->precio}}</span></font>
